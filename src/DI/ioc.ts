...
container.register({
    ...
    AsigneExclusiveContentProductRepository: asFunction(AsigneExclusiveContentProductRepositoryImpl),

    // USES CASES
    CreateProductUseCase: asFunction(CreateProductUseCase),
    AsigneProductUseCase: asFunction(AsigneProductUseCase),
    AsigneExclusiveContentProductUseCase: asFunction(AsigneExclusiveContentProductUseCase),
